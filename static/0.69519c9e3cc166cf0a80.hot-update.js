...
var mapDispatchToProps = function mapDispatchToProps(dispatch, props) {
  return {
    ...
    dispatchLikeComment: function (_dispatchLikeComment) {
      function dispatchLikeComment(_x) {
        return _dispatchLikeComment.apply(this, arguments);
      }

      dispatchLikeComment.toString = function () {
        return _dispatchLikeComment.toString();
      };

      return dispatchLikeComment;
    }(function (userId) {
      var comment = props.comment;

      dispatchLikeComment(userId, comment);
    })
  };
};
