...
var Comment = exports.Comment = function (_Base2) {
  ...
  _createClass(Comment, [{
    ...
    value: function render() {
      ...
      if (editMode) {
        return _react2.default.createElement(EditComment, { toggleEdit: this.toggleEdit });
      } else {
        return _react2.default.createElement(ViewComment, { toggleEdit: this.toggleEdit });
      }
    }
  }]);
