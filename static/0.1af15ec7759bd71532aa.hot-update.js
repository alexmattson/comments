...
var sortByTime = function sortByTime(sortDesc) {
  return function (a, b) {
    return sortDesc ? a.time < b.time : a.time > b.time;
  };
};
var sortByLikes = function sortByLikes(sortDesc) {
  return function (a, b) {
    return sortDesc ? a.likes.length < b.likes.length : a.likes.length > b.likes.length;
  };
};
  ...
  _createClass(Comments, [{
    ...
    value: function handleSort(type) {
      ...
      return function () {
        ...
        var sorting = sortDesc;
        switch (type) {
          case 'likes':
            if (sort === type) {}
            _this2.setState({
              comments: comments.sort(sortByLikes(sorting))
            });
            break;
          default:
            _this2.setState({ comments: comments.sort(sortByTime) });
        }
      };
    }
  }, {
