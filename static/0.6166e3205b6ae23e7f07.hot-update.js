...
var likeComment = exports.likeComment = function likeComment(userId, commentId) {
  return {
...
var unlikeComment = exports.unlikeComment = function unlikeComment(userId, commentId) {
  return {
