...
var mapStateToProps = function mapStateToProps(state) {
  return {
    ...
    comments: Object.values(state.comments).sort(handleSort(tate.currentUser.prefrences.sorting))
  };
};
  ...
  _createClass(Comments, [{
    ...
    value: function handleSort(type) {
      ...
      var _props = this.props,
          ...
          dispatchChangeSorting = _props.dispatchChangeSorting;
